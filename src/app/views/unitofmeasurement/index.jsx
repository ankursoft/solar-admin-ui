...
export default function Index() {
  ...
  const url = 'http://localhost:5276/SolarB2B/UnitOfMeasurements';
...
function handleAddClick() {
  navigate("/unitofmeasurement/add");
}


const handleEditClick = (id) => {
  
  navigate("/unitofmeasurement/edit?id="+ id);
};
  ...
  return (
    <Container>
      <Box className="breadcrumb">
        <Breadcrumb routeSegments={[{ name: "Unit Of Measurement", path: "/unitofmeasurement" }]} />
      </Box>
